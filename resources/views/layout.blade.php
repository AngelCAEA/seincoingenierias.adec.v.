...
<header>
    ...
    <nav class="navbar navbar-light navbar-expand-lg bg-light">
        <div class="container">
            ...
            <li class="nav-item">
                <a class=" text-dark nav-link {{setActive('inicio')}} fw-bolder" aria-current="page" href="{{ route('inicio')}}">
            ...
            <li class="nav-item">
                <a class="text-dark nav-link {{setActive('empresa')}} fw-bolder" href="{{ route('empresa')}}">
            ...
            <li class="nav-item">
                <a class="text-dark nav-link {{setActive('projects.*')}} fw-bolder" href="{{ route('projects.index')}}">
            ...
            <li class="nav-item">
                <a class="text-dark nav-link {{setActive('catalogos.*')}} fw-bolder" href="{{ route('catalogos.index')}}">
            ...
            <li class="nav-item">
                <a class="text-dark nav-link {{setActive('contactanos')}} fw-bolder" href="{{route('contactanos')}}">
            ...
            @guest
                <li class="nav-item">
                    <a class="text-dark nav-link {{setActive('login')}} fw-bolder" href="{{ route('login') }}">
