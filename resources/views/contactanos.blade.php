    ...
    <div class="row">
        ...
        <hr>               
                ...
                <div class="d-grid gap-2">
                    <a class="btn btn-primary text-dark" href="tel:+529513105838">
                    ...
                    <a class="btn btn-outline-primary text-dark" href="tel:+529516528863">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephone-forward-fill" viewBox="0 0 17 17">
                            <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511zm10.761.135a.5.5 0 0 1 .708 0l2.5 2.5a.5.5 0 0 1 0 .708l-2.5 2.5a.5.5 0 0 1-.708-.708L14.293 4H9.5a.5.5 0 0 1 0-1h4.793l-1.647-1.646a.5.5 0 0 1 0-.708z"/>
                        </svg>
                        9516528863
                ...
                <p class="fs-5 px-5">seincoingenieria089@gmail.com</p>
                <hr>
                <h5 class="mt-2">
                ...
                <div class="d-grid gap-2">
                    <a class="btn btn-success text-dark " href="https://api.whatsapp.com/send?phone=526565566545&text=Hola%20quisiera%20Obtener%20informacion%20sobre%20..?">
                    ...
                    <a class="btn btn-outline-success text-dark" href="https://api.whatsapp.com/send?phone=529516528863&text=Hola%20quisiera%20Obtener%20informacion%20sobre%20..?">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chat-right-text-fill" viewBox="0 0 17 17">
                            <path d="M16 2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h9.586a1 1 0 0 1 .707.293l2.853 2.853a.5.5 0 0 0 .854-.353V2zM3.5 3h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1 0-1zm0 2.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1 0-1zm0 2.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1z"/>
                        </svg>
                        9516528863
                    </a>
                    <a class="btn btn-outline-success text-dark" href="https://api.whatsapp.com/send?phone=529513105838&text=Hola%20quisiera%20Obtener%20informacion%20sobre%20..?">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chat-right-text-fill" viewBox="0 0 17 17">
                            <path d="M16 2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h9.586a1 1 0 0 1 .707.293l2.853 2.853a.5.5 0 0 0 .854-.353V2zM3.5 3h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1 0-1zm0 2.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1 0-1zm0 2.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1z"/>
                        </svg>
                        9513105838
                ...
                <p class="fs-5">Luis Avendaño Salazar, 2 de abril CP 69600 
        ...
        <div class="col">
            ...
            @csrf
            <h3 class="text-center text-dark">Pedir una cotización</h3>
            <div class="input-group mt-4 bg-dark text-white rounded">
